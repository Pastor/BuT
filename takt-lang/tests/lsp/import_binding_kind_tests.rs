...
/// вхождении в теле.
///
/// Проверяется **равенство ответов**, а не число: число зависит от исправлениетуры и
...
fn alias_import_is_still_a_model_name() {
    ...
    // Позиция берётся по `as Lib` со сдвигом: голое `Lib` встречается в исправлениетуре раньше -
