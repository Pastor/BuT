...
/// Однофайловый ответ одинаков с обоих курсоров - на директиве импорта и на
/// вхождении в теле.
///
...
/// Вхождение в теле связано с объявлением-импортом, а не потеряно.
///
...
/// В рабочей области оба курсора тоже дают один ответ - включая объявление в
...
/// Переименование с курсора на директиве импорта правит и библиотеку, и обоих
...
/// Имя формы `import "файл" as M;` остаётся моделью.
///
