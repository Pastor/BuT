...
//!
//! Отдельный файл по предмету: здесь разбор параметров инициализации,
...
mod lsp72_init_options {
    ...
    /// документа) - как без параметров инициализации.
    #[test]
    ...
    /// что находку даёт именно `searchPaths`, а не угадывание.
    #[test]
