...
/// **R1:** комментарий первой строкой тела остаётся в теле.
#[test]
...
/// **R2:** комментарий между операторами тела.
#[test]
...
/// **R3:** комментарий **последней строкой** тела.
///
...
/// **R4:** комментарий во вложенном `if` не всплывает на уровень состояния.
#[test]
...
/// **R5:** комментарий в теле функции не уезжает за её пределы.
#[test]
...
/// **R6:** хвостовой комментарий остаётся на строке своего оператора.
#[test]
