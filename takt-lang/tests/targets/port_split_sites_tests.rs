...
//!   во входной порт (обход тел молчал), `SE-027` не приходит на вложенную запись
//!   в выходной (одношаговый путь отвергал законное), `SE-117` не приходит на элемент
//!   порта-массива в условии (он же отвергал законное).
...
///
/// Без разворота она принимается молча, и цель печатает присваивание результату чтения - вывод
...
///
/// Контроль границы: та же запись в теле блока разворачивается всегда - расходились
