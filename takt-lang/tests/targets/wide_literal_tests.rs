...
//!   не 64: класс существует и без широких литералов, корпус его просто не содержал.
//!
//! # Устройство теста
//!
//! Два слоя: **печать** (текст вывода - быстро и точно) и
...
//! знаковое, обязано печататься без суффикса, иначе поедут снимки
//! `examples/generated/`.
...
/// Маска `[bit;64]` и максимум `u64` - значения, невыразимые в носителе `i64`.
