...
//! перечисления с числом там нет ни одного. Тот же слепой угол даёт и соседние классы.
//!
//! **Контроль обязателен**: сравнение с именем варианта (`c = Go`) печаталось верно
//! всегда - без этой проверки нельзя отличить правку сравнения с числом от порчи
//! сравнение вообще".
