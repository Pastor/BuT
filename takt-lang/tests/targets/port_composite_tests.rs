...
///
/// Прежде здесь проверялся отказ `CC-015` (колбэк HAL принимает скаляр) - утверждение,
...
/// его недостижимость держит другая фича (образец 0236, 0291).
#[test]
...
///
/// Прежде здесь стояла граница 0390 ("массив невыразим - так решает прогон yosys"), и
