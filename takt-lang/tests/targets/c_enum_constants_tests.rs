...
/// Присваивание печатается **именем константы**, а не числом.
#[test]
...
/// Начальная инициализация в `_init` - тоже присваивание.
///
...
/// Сравнение с литералом - второе место, где известен тип.
#[test]
...
/// Имя несёт сегмент перечисления, поэтому одноимённые варианты двух перечислений
/// **различимы**.
#[test]
...
/// Продюсер и потребитель зовут **одну** функцию имени - значит всякая
