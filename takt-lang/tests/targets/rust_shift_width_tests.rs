...
///
/// Прежде здесь стояла обратная проверка - "переменная величина печатается как есть", -
/// и она **закрепляла дефект**: замер 0334 показал, что такой вывод паникует в отладке
...
///
/// Прежде литеральная форма не собиралась вовсе: `rustc` отвечает "attempt to shift
