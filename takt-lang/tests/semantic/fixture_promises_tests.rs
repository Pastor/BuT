...
//! # Что здесь
//!
//! Теста тех исправлениетур, чьё обещание сформулировано **конкретно**: тип из функции,
...
/// функции - это и обещает исправлениетура.
///
...
/// исправлениетуры - "доступна в последующих операторах того же блока".
///
...
fn array_access_fixture_has_subscript() {
    ...
    // обещание исправлениетуры "здесь есть индексация элемента" держит именно `bus`.
