...
//! диагностики на фикстурах и проверяет их **тексты** на признаки внутреннего
//! представления.
...
///
/// Замер (2026-08-05): прогон по фикстурам даёт 98 сообщений, и `SE-025` среди них
/// **нет** - то есть один только обход фикстур не заметил бы возврата дампа в то самое
