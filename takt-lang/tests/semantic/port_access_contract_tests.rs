...
/// Исправлениетура: чтение числового входа, запись числового выхода, проводка бита.
...
///
/// Тест нужен по той же причине, что и у именованного порта (R11 ): документ без
...
///
/// Без этой проверки "починка", запрещающая присваивание везде, прошла бы предыдущий
