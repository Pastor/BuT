...
//! ни одной, - поэтому тест фикстурный.
...
/// Ребро после безусловного получает предупреждение с названными
/// именами.
#[test]
...
/// Высказываются все недостижимые рёбра, а не первое.
///
...
/// **Контроль: условное ребро перед безусловным законно и молчит.**
///
...
/// Ce14 остаётся при своём: два безусловных ребра - её случай, не наш.
#[test]
