...
/// Вызов функции слева: координата - строка употребления, не объявления.
#[test]
...
/// Чистый литерал слева: координата есть (её не было вовсе).
#[test]
...
/// Соседний судья (`SE-095`) получил ту же координату.
///
...
/// **Контроль: законная запись по-прежнему проходит.**
///
