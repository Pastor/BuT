...
//!
//! Модель-цепочка `S0 -> S1 -> ... -> S(N-1)` даёт обход глубиной ровно N. Пока обходы
...
//! жил не там, где его искали (карточка 0049 заявляла `verification/`, а самый низкий
...
/// PlantUML - вторая цель поверх той же карты: тест от "починили только C".
#[test]
