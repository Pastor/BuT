...
//! `--parameters=assign`).
//!
//! Проверяется **текст** вывода, а не факт сборки (анализа): молча неверная
...
/// Молчаливая победа последнего значения - тот же класс, что у усыновления.
#[test]
