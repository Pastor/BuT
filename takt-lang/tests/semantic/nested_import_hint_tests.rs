...
/// Ссылка на вложенную модель получает подсказку о выборочном импорте.
#[test]
...
/// **Контроль: опечатка подсказки не получает.**
///
...
/// Форма, которую подсказка называет, действительно работает.
///
