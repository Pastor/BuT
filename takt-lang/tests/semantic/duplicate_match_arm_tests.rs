...
//! ветвях `match`.
//!
//! Корпус класса не содержит - тест фикстурный.
...
/// Повторный образец получает предупреждение - с позицией ветви.
#[test]
...
/// Высказываются все недостижимые ветви, а не первая.
#[test]
...
/// **Контроль:** различные образцы предупреждения не дают.
///
...
/// Ветвь в теле функции и во вложенной модели тоже обходится.
#[test]
...
/// Фикстура корпуса даёт `SE-131` - код достижим проверками.
///
