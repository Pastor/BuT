...
/// **Голое имя состояния на ребре - `SE-110`.**
#[test]
...
/// **Голое имя модели на ребре - `SE-110`.**
#[test]
...
/// **То же в именованном условии и в инварианте.**
///
...
/// **Законные формы проверки состояния не задеты (регресс 0245).**
///
