...
//!
//! Проверяется **текст** вывода, а не факт сборки и **обе стороны** вывода (критерий A7
//! анализа):
//!
...
/// Константа-параметр обязана несли преисправление владельца - иначе две специализации дают
