...
//! нового вида узла не видят (приём 0143/0187/0192).
...
/// **R2:** форма переводится **всеми четырьмя** целями.
///
/// Проверяются все четыре не для полноты счёта: первая редакция правки разрешала
...
/// **R5:** реализация вместе с собственным состоянием - `SE-101`.
///
...
/// **R6:** форма без тела остаётся синтаксической ошибкой.
///
