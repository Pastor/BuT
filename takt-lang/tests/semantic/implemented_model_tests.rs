...
// -- Все формы реализации отвечают одинаково ---------------------------
...
// -- Законное не задето, соседи не перехвачены -------------------------
...
// -- Сноска о ловушке именования при `import` -----------------------------
...
// -- Ни одна цель не пропускает отказ -------------------------------------
