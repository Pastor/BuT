...
/// A2: ошибка внутри импортированного файла названа именем библиотеки, а не импортёра.
...
/// T1: импорт **никогда** не получает номер корня - при любом способе создания реестра.
///
