...
/// Одно выражение - одно значение в обеих позициях языка.
///
...
/// Деление на ноль отвергают оба - каждый своим кодом.
#[test]
...
/// Граница сдвига одна и та же (`0..63`).
#[test]
...
/// Особенность адреса цела: сравнение адресом быть не может.
///
...
/// Сужение к `i64` - прежняя обёртка по 64 битам.
///
