...
/// **Отказ указывает на объявление, а не на использование.**
///
...
/// **Текст называет правило и выход.**
///
...
/// **Накопление - одна диагностика на объявление.**
#[test]
...
/// **Контроль: непустая структура законна.**
///
...
/// **Граница: пустое перечисление судится своим кодом.**
///
