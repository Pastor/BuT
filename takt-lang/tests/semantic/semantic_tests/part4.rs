//! Интеграционные тесты семантики, часть 4.
//!
...
///
/// Проверка "файл разбирается без ошибок" здесь не годится - она проходит всё время,
...
/// `variables`; на `HashMap` их порядок плавал между прогонами, а `BTreeMap` даёт
