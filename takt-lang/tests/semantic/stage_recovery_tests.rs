...
//!
//! Без накопления стадии построения терминальны целиком: две независимые ошибки в телах
...
/// Две независимые ошибки в телах разных состояний - две диагностики.
///
...
/// Две ошибки в телах разных функций - две диагностики.
#[test]
...
/// Диагностики упорядочены **по позиции**, а не по порядку обхода.
///
...
/// Функция, зовущая упавшую, следствия не порождает.
///
...
/// Стадии предпосылок остались терминальными.
///
...
/// При ошибках построения артефактов нет.
///
...
/// его контракт эта проверка не меняет.
#[test]
