...
//! модели, **не** исправлениеированные 64: лишние старшие биты `reg_wdata` повисли бы как
...
///
/// 64 - предел `SE-060` (бит адреса в `[0, 63]`) и слово умолчаниеного HAL стороны `c-hal`
