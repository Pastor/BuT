...
//!
//! Граница модуля - ответственность: печать выражения отвечает на вопрос "как выглядит
...
///
/// Признак **синтаксический и осторожный**: он смотрит на объявленный тип операнда и на
