...
//! (clock enable): вход с умолчанием `1'b1`, проверкаящий защёлкивание в `always_ff` (`end
...
/// в файле `probe.takt`.
///
/// Прочие имена цели конфликта не дают, и это замерено (2026-09-03): порт с именем типа
...
/// проверки (`cc -Wall -Werror`, `clippy -D warnings`) вывод принимают (замер 2026-08-04).
