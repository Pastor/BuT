...
//! многомерной формой `ARRAY [0..1, 0..1] OF USINT` (T12 ). Всё остальное обязано
//! следовать этому объявлению - иначе `iec2c` отвергает вывод ("Number of
//! subscripts/indexes does not match") либо, что хуже, принимает его и теряет данные
//! молча.
//!
