...
///
/// У bit-порта номер разряда несёт само обращение (контракт 0533), у числового разряд
/// остаётся частью значения: оно читается, правится и пишется обратно, а элемент при
/// этом нулевой.
///
/// # Ошибки
