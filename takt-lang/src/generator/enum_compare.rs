...
//!
//! | Цель | Ответ инструмента без этого признака |
//! |---|---|
...
//! бы отнять имя у цели `c`, где константа перечисления печатается именем и читается
//! человеком. Форму печатает цель, признак - один.
//!
//! Соседнее правило зеркально: число рядом с перечислимым операндом (`ref Done: c = 1;`)
//! восстанавливается в вариант. Оба смотрят на тип соседа, а не на свою сторону.
