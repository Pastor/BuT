...
//!
//! Условие - самостоятельное знание, отдельное от выражения
//! ([`Expression`](crate::parser::ast_expr::Expression)): у них разная семантика `=`.
//! Путь `parser::ast::Condition` сохранён реэкспортом - от него зависят грамматика,
//! семантика, форматтер и генераторы.
