...
//!
//! Граница модуля - ответственность: в `semantic/mod.rs` объявлены дерево и его корень,
//! здесь - две самостоятельные структуры, которыми пользуются понижение, обходы и все
//! восемь печатников.
