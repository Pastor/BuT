...
//! ```
//!
//! За границей семантики подстановки не существует: печатники восьми целей не трогаются
//! вовсе. Функция, оставшаяся без вызовов, перестаёт печататься сама - фильтр
//! "используется ли функция" (`UsageSet::functions`) у целей уже есть.
//!
...
//! эвристика меняет вывод всего корпуса разом - и снимки документа, и
//! `examples/generated/`, - поэтому её умолчание выключено.
//!
//! # Названные границы
//!
