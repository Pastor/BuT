...
fn is_boolean_semantic_condition(cond: &ConditionNode) -> bool {
    match cond {
        ...
        // считаются только при её отсутствии (замер: 433 проверки на корпусе, фикстурах
        ...
        // корпуса, документа и фикстур. АСД-предикат про `after` знал всегда -
...
fn collect_implicit_bool_warnings(model: &Rc<RefCell<ModelNode>>, out: &mut Vec<Diagnostic>) {
    ...
    // Строит префикс диагностического сообщения вида "состояние 'S'" или "модель 'M',
    // состояние 'S'".
