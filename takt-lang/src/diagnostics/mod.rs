...
// Пачка диагностик: порядок, уникальность, печать.
mod batch;
...
///
/// Без резерва позиция из импортированного файла становится неотличима от корневой:
/// первый же зарегистрированный файл занял бы номер корня.
