...
impl Diagnostic {
    ...
    /// свободный номер в нужном преисправлении и добавь строку. Код без записи в реестре
...
impl Diagnostic {
    /// Возвращает форматированный преисправление кода для вывода, например `[SE-001] `. Если
