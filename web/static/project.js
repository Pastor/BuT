...
// # Чего здесь нет
//
// Ни входа, ни сохранения, ни списка проектов - это. Здесь только чтение:
...
export async function read(id, root, get = fetch) {
  ...
  return {
    ...
    // Версия модуля - свойство проекта: вывод целей меняется вместе с
 ...
 * одна точка - главный поток страницы. Строка здесь была бы
 * вторым словарём.
 */
