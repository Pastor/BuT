 ...
 *
 * Сценарии названы по модели: `heater.json`, `heater_cold.json` и
 * `heater-cold.json` принадлежат `heater.takt`, `probe.json` - нет; из подходящих моделей сценарий достаётся
