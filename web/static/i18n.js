...
//      одного места эмиссии (замер ), и второй носитель разошёлся бы
//      с первым молча -. Язык сообщений инструментов заводит фича
...
/**
 * Короткие метки языков — для кнопки в шапке (решение заказчика 2026-09-05).
 *
 * ⚠️ Метка — это КОД языка, а не перевод: «RU» читается одинаково в любой
