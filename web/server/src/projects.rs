...
//! `*.json`. Вывода целей, трасс, кадров и диагностик здесь нет и не будет: всё это
//! воспроизводится модулем версии проекта (генерация детерминирована - 0048, раскладка
//! сеяна - ) и стоило бы на порядок больше исходника (200 КиБ вывода против 17 КиБ
//! модели).
//!
//! # Ревизия
//!
...
pub struct ProjectJson {
    ...
    /// Логин владельца - псевдоним, а не персональные данные (проработка §0). Нужен
...
pub struct PatchRequest {
    ...
    /// Подъём версии модуля - **явное действие владельца** (решение A5): после него
