...
//! # Протокол
//!
//! Плоский C-ABI (решение A1 фичи): `takt_io_ptr`, `takt_io_cap`, `takt_io_reserve`,
...
///
/// Предел нужен: вывод цели `c` на модели в четыреста состояний - 200 КиБ (замер ), но
...
///
/// Кеш по версии, а не один на сервер: у проекта своя версия модуля (решение A5), и
