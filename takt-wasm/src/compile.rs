...
//! `import "file.takt";` кончается `SE-001`. Это названная граница (решение A7 фичи), а
//! не недоделка.
...
///
/// Нужна серверу (задача `0531-09p`): цель и ключи стали свойством проекта, а отвергать
