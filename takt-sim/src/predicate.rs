...
///
/// Ошибка вычисления **не** сводится к "условие ложно": она
...
/// `Location::Builtin`  в подавляющем большинстве случаев.
...
/// недостижимы: любой неподдержанный случай - `Err`.
pub(crate) fn eval_condition(
    ...
    match cond {
        ...
        // требует интерпретатора тела `fn`, который поставляет; до неё -
