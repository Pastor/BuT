...
//!
//! Файл - потомок модуля `unit`, поэтому видит приватную форму [`UnitKind`] и
//! поле-обёртку и конструирует узлы напрямую.
...
// -- Ошибка вычисления отличима от ложного условия ---
