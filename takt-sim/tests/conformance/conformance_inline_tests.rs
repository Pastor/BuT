...
//! warnings` без замечаний - вывод валиден, значения другие. Фикстура для того и держит
...
/// Фикстура раннего возврата: подстановка идёт через признак выхода, и разойтись с
