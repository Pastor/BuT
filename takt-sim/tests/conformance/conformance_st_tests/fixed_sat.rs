...
//!
//! Вынесено подмодулем: родительский файл упирается в лимит размера модуля, а правило
...
/// Исправлениетура насыщения: `q(6, 6) sat` - W = 12 при типе хранения `INT` (16 бит).
...
/// A4/A5/A6 (цель st): насыщение прижимает к границам **формата** на обеих границах и
