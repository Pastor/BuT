...
//! # Решение
//!
//! Результат вызова поднимается во временную переменную **в семантике**: за её границей формы не существует, и печатники целей не
//! трогаются вовсе.
...
///
/// Он отделяет класс от соседнего, где `c` отказывает `CC-015` на возврате
