...
//! упирается в лимит размера модуля. Помощники (`sv_trace_signed`, `simulate_trace`,
...
/// Трасса представлений исправлениетуры насыщения (та же, что у целей `c` и `st`: тестовые
...
/// A4/A5/A6 (цель sv): насыщение прижимает к границам формата на обеих границах и на
