...
fn rust_trace(
    ...
    // Наблюдение выносится из HAL общей ячейкой: поле `hal` модели приватно и аксессора
...
// -----------------------------------------------------------------------------
// Q-арифметика fixed-point: T10 для цели rust
//
...
// **byte-equality**: вывод float-исправлениетуры под --float-embedded обязан совпасть
...
fn float_embedded_matches_explicit_q_rust() {
    ...
    // Сравнивается код: исправлениетуры - разные файлы, и комментарии авторов в них законно
