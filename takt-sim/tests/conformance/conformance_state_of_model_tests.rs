...
/// Каталог сборки, уникальный по имени потока: тесты идут параллельно; двоеточие
...
/// **Наблюдатель видит чужое состояние на том же такте, что и C.**
#[test]
...
/// **Краткая форма записи равносильна полной.**
///
