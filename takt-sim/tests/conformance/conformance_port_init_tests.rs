...
/// такта" кристалла.
///
/// Сверка идёт **той же исправлениетурой**, что и с целью `c`: одна модель, два эталона - в
...
/// [0033](../../docs/features/0033-init-tick-alignment.md), обнаруженное этой задачей и
...
/// вызова тела, и тест тестыт именно его.
#[test]
