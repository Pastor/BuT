...
/// Таблица по первому аргументу - "память", из которой читает модель.
///
...
/// Одно значение на такт - форма для вызовов без осмысленного аргумента.
#[test]
...
/// **Контр-пример.** Без стенда - прежний отказ, а не ноль.
///
...
/// **Контр-пример.** Стенд, заданный на один такт, не действует на другой.
///
...
/// Ключ таблицы, не являющийся числом, - ошибка сценария.
///
