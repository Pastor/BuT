...
/// Семантика принимает агрегат в аргументе.
#[test]
...
/// Эталон видит именно заданные значения, а не умолчание модели.
///
...
/// Цель `c` печатает агрегат поэлементно.
///
...
/// **Контр-пример.** Неконстантный элемент по-прежнему отвергается.
///
...
/// Границы целей названы, а не забыты.
///
