...
//! трогается**: правка, переопределяющая тип всегда, ломает вывод из сигнатуры функции.
...
/// Сверяется с целью, а не с числом.
...
/// Без этой проверки нельзя отличить правку от смены всего поведения.
#[test]
...
///
/// Вычислитель сворачивает вызов в `0`, и правка без этого условия даёт `[bit;8]`
