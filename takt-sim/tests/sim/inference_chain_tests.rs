...
/// Та же модель **литералом** - эталон сравнения.
...
/// Переменная с выведенным по ссылке типом считается, а не падает.
///
...
/// Выдержка ссылкой ведёт себя тождественно литеральной форме.
///
/// Тождественность литеральной форме и есть критерий.
///
