...
/// **T2.** Обёртка при сужении - правило, а не усечение наугад.
///
...
/// **T3.** Число к длительности - мост через миллисекунды.
///
...
///
/// Значения у такой пары нет - есть предел глубины. Тест тестыт **завершение**: без
