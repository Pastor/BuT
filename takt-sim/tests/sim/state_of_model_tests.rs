//! Проверка состояния под-модели в эталоне: места употребления и отказы.
//!
...
/// **Именованное условие `cond`.**
///
/// Разрешение `cond` идёт другим путём, чем условие ребра, и без правки оба одинаково
/// упирались в `SIM-013`.
#[test]
...
/// **Инвариант модели (и составное условие через `|`).**
///
...
/// **Модель, не запущенная в прогоне, даёт `SIM-036`, а не "ложно".**
///
...
/// **Заглушки `SIM-013` для этого класса больше нет.**
///
