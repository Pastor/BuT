...
| 0031-03 | [`0031-fn-calls-fn.md#разработка`](0031-fn-calls-fn.md#разработка) | Версия языка 0.3.0, README (раздел «Функции»: композиция + запрет рекурсии), примеры/контрпримеры в документацию (правило 16), актуализация комментария в фикстуре и обоснования `MAX_CALL_DEPTH` |
...
>
> Ниже — план по ADR (action items A4, A5) и правилам 15, 16, 22.
...
| — | ссылки в правленых документах целы (правило 14) | `grep` по `](../development/...)` |
