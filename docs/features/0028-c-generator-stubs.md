...
| **0028-03** | [`0028-c-generator-stubs.md#разработка`](0028-c-generator-stubs.md#разработка) | фикстуры (пример/контрпример), тесты `c_stub_tests.rs`, защита корпуса от возврата заглушек, документация `CC-018` | A1–A12, правило 16 |
...
5. **Документация** (правило 15, 16): описать `CC-018` в `README.md` (раздел
...
| `README.md` | **да** | правила 8, 15, 16 — описание `CC-018` + примеры |
