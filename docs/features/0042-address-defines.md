...
- **Крейт:** `grammar`. Версия языка **не поднималась**: к моменту реализации 0.3.0 уже поднята закрытой 0029 (тег `v0.3.0`), и по правилу 22 (накопление) 0042 вносит изменения в **уже поднятую** версию. Расширение аддитивно.
...
Обновление `README.md` (правило 15).
...
(правило 15), включая оператор `address` и `--address-map` фичи. Символьные
