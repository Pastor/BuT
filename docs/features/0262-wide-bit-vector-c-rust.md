...
| LSP и плагины | — | новых токенов, форм объявления, узлов АСД и диагностик языка нет |
...
| LSP и плагины | — | новых токенов, форм объявления, узлов АСД и диагностик языка нет |
| Документ `book/` | ✅ | раздел «Битовый вектор `[bit; N]`» дополнен |

### Выводы и дальнейшие шаги

- Исправления не нужны; фича закрывается.
- **Кандидат заведён**: текст `SIM-011` называет диапазон `0..64`
  ...
  верна.
- **Кандидатов, называющих 0262, не осталось**: запись блока 2 была
...
**Замер снят заново** и подтвердил кандидата: `cc` давал четыре
