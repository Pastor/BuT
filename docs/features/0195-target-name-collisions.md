...
**Cons:**
- язык получает **новое ограничение** → требуется документирование
  и заметка о типичных ошибках;
...
- **A4.** Документирование — обязательно при Option B: новое
...
| М5 | документ языка | `book/src/` | новое ограничение — разделы о моделях и портах |
...
| 0195-03 | документирование: раздел о моделях/портах, заметка о типичных ошибках |
...
портах документа `book/`, плюс заметка о типичных ошибках. Объём.
...
| Редакторский слой | новая диагностика идёт общим путём — см. анализ | — |
...
Документирование выполнено: раздел о моделях и приложение об
...
и портах, плюс заметка о типичных ошибках. Если выбран путь (а),
