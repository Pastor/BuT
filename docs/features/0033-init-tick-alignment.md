...
| [согласование тактов симулятора и порождённого C (INIT-такты)](0033-init-tick-alignment.md#разработка) | Семантика такта в README, версия языка `0.3.0`, `CHANGES.md` (R8, правила 15, 16, 22) |
...
1. **Версия языка — накопление в `0.3.0`, без нового подъёма** (правило 22,
   решение заказчика 2026-07-15 о накоплении). На момент реализации 0033 версия
...
| `CLAUDE.md` | **Да** — снятие инварианта | Правило 4 |
...
- Примеры из README **прогнаны** и совпадают с фактическими трассами обеих сторон
  ...
  отсутствия.
- Ссылки целы (правило 14): `grep` по `](../development/...)` после правок.
...
- **Документация:** README — раздел «Семантика первого такта» с верифицированным
  потактовым примером (правило 16); версия языка **накоплена в 0.3.0** без нового
  подъёма (правило 22 — подъём сделала 0029); `CLAUDE.md` — снят инвариант «цель
