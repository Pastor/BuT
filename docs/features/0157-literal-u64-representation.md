...
- Язык меняется: расширено множество допустимых литералов, добавлена
  диагностика диапазона. **Номер версии при этом не растёт**: правило 22 —
...
(правило 11 + детерминизм [детерминированная генерация кода (единый порядок эмиссии)](0048-deterministic-codegen.md#архитектура-adr)).
...
| T20 | Версия языка согласована | три источника | проверка зелёный; номер **не** меняется (правило 22) | A9 |
...
| T20 | Версия языка согласована | ✅ | проверка зелёный; номер не менялся (правило 22) |
