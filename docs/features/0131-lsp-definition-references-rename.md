...
- **R6. Совместимость.** Вывод генераторов на `examples/` байт-в-байт неизменен;
  прежние возможности LSP не затронуты (правка аддитивна).
...
Правка **аддитивна**: добавляются новые методы LSP и новый
...
Правка аддитивна: прежние возможности объявляются в том же составе,
их тесты не тронуты.
...
байт-в-байт прежний. Документирование по своду не требовалось.
