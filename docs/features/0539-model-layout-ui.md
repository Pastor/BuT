...
- **Номер:** 0539
- **Статус:** РАЗРАБОТКА (с 2026-09-08; задачи 01–07 сделаны, оформление принято;
  остались 08 — документ и 09 — подсветка прогона по решению заказчика)
...
08 — документ (подраздел «Онлайн-редактор») и README; 09 — подсветка
прогона по решению заказчика (носитель на холсте готов: `setRunning`).
