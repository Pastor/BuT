...
Задача **большая** и по правилу 2 подлежит декомпозиции: на стадии анализа
...
**Замер-04 (проба, правило 30): крейты собираются под WebAssembly без
...
- **Осиротевшие каталоги не подметаются**: проект, чья строка исчезла мимо
  ...
  кандидат, и оно названо здесь, а не забыто. **Снято задачей `09j`**
