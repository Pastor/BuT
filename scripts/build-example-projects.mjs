...
// Сжатие - deflate (метод 8); время файлов - наименьшее, какое знает формат zip, чтобы архив был
...
function zip(entries) {
  ...
  for (const entry of entries) {
    ...
    local.writeUInt16LE(0x21, 12); // наименьшая дата формата
