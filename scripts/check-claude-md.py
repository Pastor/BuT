...
def check_crate_versions(lines, problems):
    ...
    for number, text in paragraphs(lines):
        ...
        # класс символов их не исключает - исключи он их, и мутация
...
def self_test():
    ...
    cases = {
        ...
        # между именем крейта и версией. Самопроверка, берущая
        ...
        # Граница, снятая замером: перенос внутри одного токена в
