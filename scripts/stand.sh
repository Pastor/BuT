...
# ⚠️ Префикс и адрес привязки берутся ИЗ ФАЙЛА ОКРУЖЕНИЯ, если их нет в самом
...
#
# ⚠️ Читается ровно ДВЕ переменные, а не весь файл: рядом с ними лежат пароль
...
#
# ⚠️ Проверка нужна потому, что включение живёт в ЧУЖОМ файле. Домен занят
# соседним сервисом (задача 07d), Takt приносит только локейшены, и его
...
#
# ⚠️ Проверка МЯГКАЯ: без nginx (своя машина, контейнерный прокси) она молчит —
