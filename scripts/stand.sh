...
# Преисправление входит в адрес проверки живости: сервер вкладывает под него весь
...
# мёртвым (нашлось при разборе выкатки под преисправлением, d).
# Преисправление и адрес привязки берутся из файла окружения, если их нет в самом
