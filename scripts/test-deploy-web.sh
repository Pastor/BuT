...
# -- E10: проверка живости знает преисправление -------------------------------------
# Сервер вкладывает под преисправление весь роутер: при `TAKT_WEB_BASE_PATH=/takt`
# ручка живёт по `/takt/health`, и проверка без преисправления отвечает 404. Живой
