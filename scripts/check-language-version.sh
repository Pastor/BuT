...
#
# Третий источник - CLAUDE.md. Прежде проверка сверял два источника из
...
# предмет, неизбежно разъезжаются (прецеденты - CI-проверки 0090, формат позиции
# ). Прежде версия жила только в README, и
