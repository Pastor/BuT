...
# Модели корпуса: по лифту проверяется граф модуля и сверка раскладки, по
# нагревателю с библиотекой - подсветка двух экземпляров одной модели, а сверка
# паритета геометрии холста и чертежа читает корпус целиком. Копия дерева - не
# "весь проект": файл, который тесты читают, а тест не кладёт, роняет B4 с чужой
# причиной.
